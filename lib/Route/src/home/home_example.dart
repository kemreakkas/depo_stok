// ignore_for_file: use_super_parameters, library_private_types_in_public_api, avoid_print, use_build_context_synchronously, deprecated_member_use, avoid_unnecessary_containers, prefer_const_declarations, use_key_in_widget_constructors
...
class OldMainExample extends StatefulWidget {
  const OldMainExample({Key? key}) : super(key: key);
